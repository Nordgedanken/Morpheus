...
import (
	...
	custom_messages "github.com/Nordgedanken/Morpheus/matrix/messages"
...
func callbackQVBoxLayoutWithTriggerSlot_TriggerMessage(ptr unsafe.Pointer, message unsafe.Pointer) {
	if signal := qt.GetSignal(ptr, "TriggerMessage"); signal != nil {
		signal.(func(*custom_messages.Message))(custom_messages.NewMessageFromPointer(message))
	}

}

func (ptr *QVBoxLayoutWithTriggerSlot) ConnectTriggerMessage(f func(message *custom_messages.Message)) {
	if ptr.Pointer() != nil {
		...
		if signal := qt.LendSignal(ptr.Pointer(), "TriggerMessage"); signal != nil {
			qt.ConnectSignal(ptr.Pointer(), "TriggerMessage", func(message *custom_messages.Message) {
				signal.(func(*custom_messages.Message))(message)
				f(message)
			})
		} else {
...
func (ptr *QVBoxLayoutWithTriggerSlot) TriggerMessage(message custom_messages.Message_ITF) {
	if ptr.Pointer() != nil {
		C.QVBoxLayoutWithTriggerSlot_TriggerMessage(ptr.Pointer(), custom_messages.PointerFromMessage(message))
	}
}

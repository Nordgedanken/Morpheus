...
public:
	...
	void Signal_TriggerMessage(Message* message) { callbackQVBoxLayoutWithTriggerSlot_TriggerMessage(this, message); };
...
{
	QObject::connect(static_cast<QVBoxLayoutWithTriggerSlot*>(ptr), static_cast<void (QVBoxLayoutWithTriggerSlot::*)(Message*)>(&QVBoxLayoutWithTriggerSlot::TriggerMessage), static_cast<QVBoxLayoutWithTriggerSlot*>(ptr), static_cast<void (QVBoxLayoutWithTriggerSlot::*)(Message*)>(&QVBoxLayoutWithTriggerSlot::Signal_TriggerMessage));
}

void QVBoxLayoutWithTriggerSlot_DisconnectTriggerMessage(void* ptr)
{
	QObject::disconnect(static_cast<QVBoxLayoutWithTriggerSlot*>(ptr), static_cast<void (QVBoxLayoutWithTriggerSlot::*)(Message*)>(&QVBoxLayoutWithTriggerSlot::TriggerMessage), static_cast<QVBoxLayoutWithTriggerSlot*>(ptr), static_cast<void (QVBoxLayoutWithTriggerSlot::*)(Message*)>(&QVBoxLayoutWithTriggerSlot::Signal_TriggerMessage));
}

void QVBoxLayoutWithTriggerSlot_TriggerMessage(void* ptr, void* message)
{
	static_cast<QVBoxLayoutWithTriggerSlot*>(ptr)->TriggerMessage(static_cast<Message*>(message));
}

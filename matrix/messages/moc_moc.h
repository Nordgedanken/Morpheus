...
QT_MOC_LITERAL(1, 8, 9), // "SetAvatar"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 6) // "avatar"

    },
    "Message\0SetAvatar\0\0avatar"
};
...
void Message::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Message::*_t)(QPixmap );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Message::SetAvatar)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Message::SetAvatar(QPixmap _t1)
{
